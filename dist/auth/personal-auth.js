...
async function simulateLogin(baseUrl, subdomain, credentials) {
...
async function getTransactionId(baseUrl, cookie, clientId) {
...
async function getAuthorizationCode(baseUrl, cookie, transactionId) {
...
function getApiPrefix(isPrivate) {
    return isPrivate ? '/open' : '';
}
async function exchangeCodeForToken(baseUrl, code, clientId, clientSecret, isPrivate) {
...
export async function getPersonalToken(baseUrl, credentials, isPrivate, subdomain) {
...
//# sourceMappingURL=personal-auth.js.map