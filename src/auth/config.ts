...
import type { AuthState, PersistedAuthState, TokenPair, AuthConfig } from './types.js';
...
export function loadAuthState(): AuthState | null {
  try {
    ...
    const persisted: PersistedAuthState = JSON.parse(data);
...
export function isTokenValid(tokens: TokenPair | null): boolean {
